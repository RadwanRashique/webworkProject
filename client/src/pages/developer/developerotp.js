...
function ForgotPasswordOTPPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-purple-300">
      <div className="max-w-md w-full sm:max-w-sm md:max-w-lg bg-white p-4 md:p-8 rounded-lg shadow-lg mx-auto">
        <h2 className="text-2xl font-bold text-center text-purple-600 mb-4 md:mb-6">OTP Verification</h2>
        ...
        {resendDisabled ? (
          <div className="flex justify-center items-center">
            <span className="text-center text-gray-600 mt-2 md:mt-4 ">
          ...
          <div className="flex justify-center items-center">
            <button
              ...
              className="bg-blue-500 hover-bg-blue-600 text-white font-semibold py-2 px-4 rounded-full w-full md:w-1/2 mt-4"
            >
              Resend OTP
            </button>
          </div>
